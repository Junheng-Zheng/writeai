...
const InfoContent = ({ title, children, position = "right" }) => {
  return (
    <div className="sm:px-[48px] border-t border-black/10 ">
      <div
